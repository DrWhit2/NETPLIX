...
const SERIES = [
  ...
  { title:"크레이브 엑스 1", file:"2.png", match:90, year:2017, age:"15+", genres:["오프더레코드, 현실다큐"], overview:"〈크레이브 엑스〉 촬영 초반, 오스월드 역의 배우가 돌연 하차하며 제작팀은 패닉에 빠진다. 감독은 급히 스태프의 딸 이자벨을 투입해 “오스월드가 변장했다”는 억지 설정을 덧붙이는데... 과연 이 드라마는 무사히 방영될 수 있을까?" },
  { title:"크레이브 엑스 2", file:"3.png", match:90, year:2025, age:"19+", genres:["현실다큐, 범죄기록"], overview:"〈크레이브 엑스〉 촬영은 막바지에 접어든다. 오스월드의 변장 설정에 대한 대중들의 반응은 싸늘하다. 결국 감독은 초대 오스월드 배우를 다시 찾으려 했으나, 돌아온 소식은 실종이라는 충격적인 답뿐. 그때 정체불명의 한 청년이 오스월드역 오디션에 나타난다. 완벽해 보이는 그의 연기 뒤로 현장은 알 수 없는 불길함에 휩싸인다." },
...
const EPISODES = {
  ...
  [normalize("크레이브 엑스 - 오프 더 레코드 2")]: [
    ...
    { no: 4, duration: "52분", desc: "그가 오스월드를 모욕하는 것처럼 들리는 대본을 수정해달라고 항의한 것도 수차례. 그는 단순 오스월드 캐릭터의 광팬인 것일까?" },
    { no: 5, duration: "52분", desc: "제작진은 결국 신인 배우 W와의 계약을 파기하고 초대 배우의 복귀를 요청한다. 그러나 돌아온 답은 단 하나 — 초대배우가 실종됐다는 충격적인 소식뿐이다." },
    { no: 6, duration: "52분", desc: "돌연 경찰이 크레이브 엑스 촬영장에 들이닥친다. 검찰은 W를 초대 오스월드 배우 살해와 시신 유기 혐의로 기소했고, 갑작스러운 상황에 현장은 순식간에 아수라장이 된다." },
    { no: 7, duration: "54분", desc: " “오스월드 역”을 차지한 이 W라는 청년은 과연 누구이며, 그는 어떤 수법으로, 왜 초대 배우를 살해했는가. 드라마 제작기를 다루던 다큐멘터리는 법정 증언과 수사 기록을 토대로 범인의 실체를 파헤치는 프로그램으로 변모한다." }
  ],

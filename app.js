...
const EPISODES = {
  ...
  [normalize("크레이브 엑스 - 오프 더 레코드 2")]: [
    { no: 1, duration: "53분", desc: "제작팀은 결국 오스월드 역을 공개 오디션으로 전환한다. 26번째 순서에 등장한 신인배우 'W'는 목소리와 표정, 분위기, 말투까지 캐릭터와 놀라운 싱크로율을 보여주며, 결국 오스월드 역으로 발탁된다." },
    { no: 2, duration: "51분", desc: "W는 촬영이 끝난 순간에도 캐릭터의 말투와 행동을 흉내 내며, 예기치 못한 기행으로 동료 배우들을 기겁하게 만든다. 카메라는 그의 이상 행동들을 포착해 나간다." },
    { no: 3, duration: "52분", desc: "W가 오스월드를 모욕하는 것처럼 들리는 대본을 수정해달라고 항의한 것도 수차례. 그는 단순 오스월드 캐릭터의 광팬인 것일까?" },

...
const SERIES = [
  ...
  { title:"크레이브 엑스 1", file:"2.png", match:90, year:2024, age:"15+", genres:["오프더레코드, 현실다큐"], overview:"〈크레이브 엑스〉 촬영 초반, 오스월드 역의 배우가 돌연 하차하며 제작팀은 패닉에 빠진다. 감독은 급히 스태프의 딸 이자벨을 투입해 “오스월드가 변장했다”는 억지 설정을 덧붙이는데... 과연 이 드라마는 무사히 방영될 수 있을까?" },

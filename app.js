...
const MOVIES = [
  ...
  { title:"퍼펙트 블루", file:"d.png", match:97, year:1997, age:18, cast:["이와마 사키","마츠모토 코헤이"], genres:["애니메이션","스릴러"], tags:["심리","호러"], overview:"아이돌을 그만두고 배우로 전향한 ‘미마’에게 또 하나의 자신, 미마가 나타난다. 미마는 결국 미쳐버린 것일까? 아니면 꿈일까? 세간을 떠들석하게 한 연속살인 사건의 범인은 자신인 것일까? 애초에 '자신'은 누구일까? 미마는 점점 정체성을 잃어가게 되는데..." },
  ...
  { title:"양들의 침묵", file:"j.png", match:99, year:1991, age:18, cast:["조디 포스터","안소니 홉킨스"], genres:["스릴러","범죄"], tags:["심리전","명작"], overview:"FBI 수습요원 ‘클라리스’는 연쇄살인마를 잡기 위해 천재 식인범 정신과 의사 ‘한니발 렉터’에게 도움을 청한다. 렉터의 심리전 속에서 단서를 맞춰 나가며 클라리스는 범죄자와 자신 내면의 트라우마를 동시에 마주한다." },
  { title:"A.I.", file:"k.png", match:89, year:2001, age:"12+", cast:["헤일리 조엘 오스먼트","주드 로"], genres:["SF","드라마"], tags:["휴머니즘","미래"], overview:"가까운 미래, 감정을 느끼도록 설계된 인조 소년 데이비드가 인간 부부의 집에 입양된다. 버림받은 뒤 그는 ‘엄마’의 사랑을 되찾기 위한 여정을 떠나며 인간성과 사랑의 의미를 묻는다." },
  { title:"터스크", file:"m.png", match:84, year:2014, age:18, cast:["저스틴 롱","마이클 파크스"], genres:["호러"], tags:["기괴","블랙코미디"], overview:"팟캐스터 월레스는 취재차 캐나다에 갔다가, 기묘한 전단을 따라 외딴 집의 노인 하워드 하우를 찾아간다. 하워드는 매혹적인 항해담으로 월레스를 방심시킨 뒤 감금하고, 과거의 집착을 투사해 그를 ‘바다코끼리’로 개조하려는 광기 어린 수술을 시작한다." },
  ...
  { title:"오펀: 천사의 아이", file:"o.png", match:86, year:2009, age:"15+", cast:["베라 파미가","이사벨 퍼만"], genres:["호러","스릴러"], tags:["충격 반전"], overview:"입양을 결심한 케이트와 존은 고아원에서 성숙하고 예의 바른 아홉 살 소녀 에스더를 데려온다. 하지만 집에 온 뒤로 사고와 불행이 잇따르며, 케이트는 아이의 말과 행동에서 설명하기 힘든 불길함을 감지한다. 결국 케이트는 아이의 정체를 의심하고 과거를 조사하며 충격적인 실체에 다가간다." },
  { title:"비바리움", file:"p.png", match:87, year:2019, age:"15+", cast:["이모겐 푸츠","제시 아이젠버그"], genres:["SF","스릴러"], tags:["디스토피아","폐쇄공간"], overview:"집을 보러 간 커플은 모든 집이 똑같은 미로 같은 신도시에 갇힌다. 어떤 방향으로 향해도 집 앞에 다다르는 이 네모반듯한 곳에서 다른 선택지는 없다, 오직 살아갈 뿐! 탈출이 불가능한 상황에서 둘은 정체불명의 아이까 키우게 되며, 일상은 점차 괴랄하게 변해 간다." },
  ...
  { title:"써클", file:"s.png", match:83, year:2015, age:18, cast:["줄리 벤즈","카터 젠킨스"], genres:["SF","스릴러"], tags:["사회실험","심리"], overview:"당신에게는 살 가치가 있습니까? 어두운 방 안, 50명의 사람이 각자 빨간 원을 디딘 채로 서있다. 오로지 대화만이 허용된 이곳에서 이들은 2분마다 다수결로 죽을 사람을 투표로 선출해야 하고, 살아남기 위한 치열한 논쟁이 펼쳐진다. 자신의 생존을 위한 설득과 담합, 차별과 도덕이 뒤엉킨 끝에 마지막 선택이 다가온다." },
  ...
  { title:"Capsules", file:"u.png", match:88, year:2022, age:"15+", cast:["Dust"], genres:["단편","SF"], tags:["실험","기억"], overview:"감정을 느끼기 위해 캡슐을 복용하는 세상을 그린 단편 영화. 한 쌍의 남녀 커플은 '사랑' 캡슐을 복용하며 서로 사랑을 나눈다. 하지만 시간이 갈수록 둘은 '사랑' 캡슐의 약효가 점점 떨어져가는 것을 느끼는데..." }
];

/* ====== 시리즈 ====== */
const SERIES = [
  { title:"Rabid Rabbit", file:"1.png", match:92, year:2015, age:"19+", genres:["좀아포, 하이틴"], overview:"금발의 치어리더 '아일리'는 과학자 '오스월드 화이트'를 납치해, 자신의 반려 토끼를 불사신으로 만들 것을 강요한다. 영문도 모른 채 끌려온 오스월드는 결국 금기를 깨뜨리고 실험을 완성한다. 그러나 오스월드의 손끝에서 되살아난 토끼는 피투성이 좀비가 되어,런던 교정을 시작으로 영국 전역을 파멸 속에 몰아넣는데..." },
  { title:"크레이브 엑스 1", file:"2.png", match:90, year:2024, age:"15+", genres:["오프더레코드, 현실다큐"], overview:"〈크레이브 엑스〉 촬영 초반, 오스월드 역의 배우가 돌연 하차하며 스태프들은 패닉에 빠진다. 감독은 급히 스태프의 딸 이자벨을 투입해 “오스월드가 변장했다”는 억지 설정을 덧붙인다. 심지어 친구들마저 돌아가며 오스월드 흉내를 내며 그의 4학년 분량을 겨우 소화해내는데... 과연 이 드라마는 무사히 방영될 수 있을까?" },
  { title:"크레이브 엑스 2", file:"3.png", match:90, year:2024, age:"19+", genres:["현실다큐, 범죄기록"], overview:"〈크레이브 엑스〉 촬영은 막바지에 접어든다. 오스월드의 변장 설정에 대한 대중들의 반응은 싸늘하다. 결국 감독은 초대 오스월드 배우를 다시 찾으려 했으나, 돌아온 소식은 실종이라는 충격적인 답뿐. 그때 정체불명의 한 청년이 오스월드역 오디션에 나타난다. 완벽해 보이는 그의 연기 뒤로 현장은 알 수 없는 불길함에 휩싸인다." },
  ...
  { title:"101번째 재혼", file:"5.png", match:90, year:2024, age:"12+", genres:["개그"], overview:"연구원 화이트는 재벌 사업가 대니와 100번의 결혼과 이혼 끝에 다시금 재혼을 노린다. 점차 기괴한 희극으로 번져가는 이야기 속에서 그는 재혼에 성공할 수 있을까?" }
];
...
const EPISODES = {
  [normalize("Rabid Rabbit")]: [
    { no: 1, duration: "48분", desc: "치어리딩 연습이 끝난 저녁, 아일리에게 닥친 것은 뜻밖의 이별 통보였다. 남자친구는 차갑게 돌아서고, 아일리는 교정 한쪽에 홀로 남겨진다. 울적한 마음을 달래주는 건 언제나 그녀의 반려토끼뿐이다." },
    { no: 2, duration: "51분", desc: "아일리는 반려 토끼를 불사신으로 만들고 싶다는 생각에, 괴짜 과학자로 소문난 오스월드 화이트를 납치한다. 그러나 오스월드 손에서 토끼는 좀비로 개조되어 버리고, 이 좀비 바이러스가 사람에게까지 전염되기 시작하며 런던 교정은 순식간에 아수라장이 된다." },
    { no: 3, duration: "49분", desc: "피로 시작된 공격은 빠르게 확산된다. 학생과 시민들이 감염되며, 런던 도심 전체가 공포에 잠긴다. 아일리는 자신이 불러온 재앙을 깨닫지만, 이미 늦었다는 것을 깨닫는다." },
  ],
  [normalize("크레이브 엑스 1")]: [
    { no: 1, duration: "47분", desc: "촬영 개시 직후, 주연 배우가 돌연 하차한다. 제작진은 충격에 빠지고, 촬영장은 순식간에 혼란에 휩싸인다. 감독은 불가능에 가까운 선택을 내린다. 그는 스태프의 딸 이자벨을 투입해 “오스월드가 변장했다”는 설정을 억지로 끼워 넣는 것이다." },
    { no: 2, duration: "50분", desc: "이자벨만으로는 모든 분량을 소화하기 어려웠다. 급기야 주변의 배우들이 돌아가며 오스월드를 흉내 내기 시작한다. 목소리, 걸음걸이, 심지어 표정까지 카메라 앞에서 조율되지만, 어색함은 감출 수 없다. 현장의 스태프들은 이 무모한 결정이 과연 시청자들에게 통할 수 있을지 의문을 품는다." },
    { no: 3, duration: "49분", desc: "방영이 이어질수록 대중의 반응은 싸늘해진다. 설정이 작위적이라는 비판이 쏟아지고, 시청률은 곤두박질친다. 내부 회의에서는 “초대 오스월드 배우를 다시 데려와야 한다”는 절박한 목소리가 커져만 간다." }
  ],
  [normalize("크레이브 엑스 2")]: [
    { no: 1, duration: "53분", desc: "감독은 결국 사라진 배우를 찾기 위해 나섰지만, 돌아온 소식은 충격적이었다. 초대 오스월드 배우가 실종 상태였던 것이다. 제작팀은 더 이상 기다릴 수 없어 오스월드 역을 공개 오디션으로 전환한다." },
    { no: 2, duration: "51분", desc: "정체불명의 한 청년이 이 오디션에 등장한다. 목소리와 표정, 분위기까지 초대 오스월드 배우를 연상케 하는 기묘한 싱크로율. 그러나 스태프들은 왜인지 설명할 수 없는 불길함에 사로잡힌다." },
    { no: 3, duration: "52분", desc: "결국 오스월드 역에 발탁된 청년. 그는 촬영이 끝난 순간에도 캐릭터의 말투와 행동을 흉내 내며, 예기치 못한 기행으로 동료 배우들을 기겁하게 만든다. 특히 오스월드에 대한 집착은 지나칠 정도. 그가 제작진에게 오스월드를 모욕하는 것처럼 들리는 대본을 수정해달라고 항의한 것도 수차례, 카메라는 그의 이상 행동을 포착해 나간다." },
    { no: 4, duration: "54분", desc: "돌연 경찰이 촬영장에 들이닥친다. 검찰은 그를 초대 오스월드 배우 살해와 시신 유기 혐의로 기소했고, 갑작스러운 상황에 현장은 순식간에 아수라장이 된다. “오스월드 역”을 차지한 이 청년은 과연 누구이며, 그는 어떤 수법으로, 왜 초대 배우를 살해했는가. 드라마 제작기를 다루던 다큐멘터리는 법정 증언과 수사 기록을 토대로 범인의 실체를 파헤치는 프로그램으로 변모한다." }
  ],
  [normalize("멸망한 세계의 마지막 수신")]: [
    ...
    { no: 2, duration: "46분", desc: "수많은 시도 끝에 오스월드 화이트는 고장 난 지상 통신기를 복구하는 데 성공하고, 그의 신호는 끝없는 우주를 표류하던 대니 쉘비스에게 도달한다. 당신 인류가 남긴 마지막 대화, 다섯 번의 문자로 이어지는 최후의 통신이 시작된다." },
  ...
  [normalize("101번째 재혼")]: [
    ...
    { no: 2, duration: "45분", desc: "101번째 청혼. 화이트는 반짝이는 반지 대신 두툼한 사업계획서를 내밀지만 대니는 냉소적인 미소로 서류를 덮는다. 연구 자금이 바닥나자 화이트는 점차 초조해지고, 새로운 수단을 궁리한다." },
    { no: 3, duration: "47분", desc: "화이트는 대니의 연인을 흉내 내어 그의 마음을 되돌리려 하지만, 따라 하는 대사와 몸짓은 어설프기만 하다. 모든 시도가 실패로 돌아간 뒤, 자포자기한 화이트는 계획서도, 연인 행세도 내려놓는다. 빈손으로, 그러나 처음으로 진심을 담아 대니를 붙잡아 본다." },
    { no: 4, duration: "47분", desc: "뜻밖에도 대니는 그 마음을 받아들이며 수락한다. 두 사람은 마침내 101번째 재혼에 성공하며 잠시나마 평화와 화해가 찾아온 듯 보였다. 그러나 검은 메뚜기 건축물 사건이 터지며 두 사람의 관계는 다시 파국으로 돌아서는데... " }
  ]
};

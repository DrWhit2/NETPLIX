...
const MOVIES = [
  ...
  { title:"Capsules", file:"u.png", match:88, year:2022, age:"15+", cast:["Dust"], genres:["단편","SF"], tags:["감성"], overview:"감정을 느끼기 위해 캡슐을 복용하는 세상을 그린 단편 영화. 한 쌍의 남녀 커플은 '사랑' 캡슐을 복용하며 서로 사랑을 나눈다. 하지만 시간이 갈수록 둘은 '사랑' 캡슐의 약효가 점점 떨어져가는 것을 느끼는데..." }
];
...
const SERIES = [
  ...
  { title:"크레이브 엑스 1", file:"2.png", match:90, year:2024, age:"15+", genres:["오프더레코드, 현실다큐"], overview:"〈크레이브 엑스〉 촬영 초반, 오스월드 역의 배우가 돌연 하차하며 제작팀은 패닉에 빠진다. 감독은 급히 스태프의 딸 이자벨을 투입해 “오스월드가 변장했다”는 억지 설정을 덧붙인다. 심지어 친구들마저 돌아가며 오스월드 흉내를 내며 그의 4학년 분량을 겨우 소화해내는데... 과연 이 드라마는 무사히 방영될 수 있을까?" },
  ...
  { title:"101번째 재혼", file:"5.png", match:90, year:2024, age:"12+", genres:["개그"], overview:"연구원 화이트는 재벌 사업가 대니와 100번의 결혼과 이혼 끝에 다시금 재혼을 노린다. 점차 기괴한 희극으로 번져가는 이야기 속에서 과연 그는 재혼에 성공할 수 있을까?" }
];
...
const EPISODES = {
  [normalize("Rabid Rabbit")]: [
    ...
    { no: 2, duration: "51분", desc: "아일리는 반려 토끼를 불사신으로 만들고 싶다는 생각에, 괴짜 과학자로 소문난 오스월드 화이트를 납치한다. 그러나 오스월드 손에서 토끼는 좀비로 개조되어 버리고, 바이러스는 사람에게까지 전염되기 시작하며 런던 교정은 순식간에 아수라장이 된다." },
  ...
  [normalize("크레이브 엑스 2")]: [
    ...
    { no: 2, duration: "51분", desc: "정체불명의 한 청년이 오디션에 등장한다. 목소리와 표정, 분위기까지 초대 오스월드 배우를 연상케 하는 기묘한 싱크로율. 그러나 스태프들은 왜인지 설명할 수 없는 불길함에 사로잡힌다." },
    { no: 4, duration: "52분", desc: "결국 오스월드 역에 발탁된 청년. 그는 촬영이 끝난 순간에도 캐릭터의 말투와 행동을 흉내 내며, 예기치 못한 기행으로 동료 배우들을 기겁하게 만든다. 특히 오스월드에 대한 집착은 지나칠 정도. 그가 제작진에게 오스월드를 모욕하는 것처럼 들리는 대본을 수정해달라고 항의한 것도 수차례, 카메라는 그의 이상 행동을 포착해 나간다." },
    { no: 5, duration: "52분", desc: "그가 오스월드를 모욕하는 것처럼 들리는 대본을 수정해달라고 항의한 것도 수차례. 그는 단순 오스월드 캐릭터의 광팬인 것일까? 카메라는 그의 이상 행동들을 포착해 나간다." },
  ...
  [normalize("101번째 재혼")]: [
    ...
    { no: 4, duration: "47분", desc: "모든 시도가 실패로 돌아간 뒤 자포자기한 화이트는 사업계획서도, 우스꽝스러운 연인 행세도 모두 내려놓는다. 이제 화이트에겐 더이상 쓸만한 수단이 없다." },
